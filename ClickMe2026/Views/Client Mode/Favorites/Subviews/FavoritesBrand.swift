...
enum FavoritesBrand {
    ...
    static let navBg = Color(red: 0.055, green: 0.055, blue: 0.060)
    static let cardBg = Color(red: 0.075, green: 0.075, blue: 0.080)
    static let cardBorder = Color(red: 0.160, green: 0.160, blue: 0.170)
    static let chipBg = Color(red: 0.120, green: 0.120, blue: 0.130)
...
struct FavScaleStyle: ButtonStyle {

...
enum MyBookingsBrand {
    static let bg = Color(red: 0.060, green: 0.075, blue: 0.075) // #0f1313
    static let cardBg = Color(red: 0.090, green: 0.110, blue: 0.108) // #17181b
    static let cardBorder = Color(red: 0.175, green: 0.235, blue: 0.210)
...
struct BookingScaleStyle: ButtonStyle {

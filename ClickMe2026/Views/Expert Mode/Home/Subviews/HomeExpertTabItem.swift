        ...
        Button(action: action) {
            VStack(spacing: 4) {
                Image(systemName: tab.systemImage)
                    ...
                    .foregroundColor(isActive ? HomeExpertBrand.primary : HomeExpertBrand.onSurfaceVariant)
                    .shadow(
                        color: isActive ? HomeExpertBrand.primary.opacity(0.55) : .clear,
                ...
                Circle()
                    .fill(HomeExpertBrand.primary)
                    .frame(width: 4, height: 4)
                    .shadow(color: HomeExpertBrand.primary.opacity(0.7), radius: 4)

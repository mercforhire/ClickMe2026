    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            Circle()
                .fill(RadialGradient(
                    colors: [
                        ExpertProfileSettingsTheme.brandGreen.opacity(0.38),
                        ExpertProfileSettingsTheme.brandGreen.opacity(0.0),
                    ],
            ...
            // Border ring
            Circle()
                .stroke(ExpertProfileSettingsTheme.brandGreen, lineWidth: 3)
                .frame(width: 140, height: 140)
                .shadow(color: ExpertProfileSettingsTheme.brandGreen.opacity(0.60), radius: 10)
            ...
            PhotosPicker(selection: $viewModel.selectedPhoto, matching: .images) {
                ZStack {
                    Circle()
                        ...
                        .overlay(Circle().stroke(ExpertProfileSettingsTheme.brandGreen.opacity(0.60), lineWidth: 1))

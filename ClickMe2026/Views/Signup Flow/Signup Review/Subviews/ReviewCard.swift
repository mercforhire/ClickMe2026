    ...
    var body: some View {
            ...
            HStack {
                ...
                Button(action: onEdit) {
                    Image(systemName: "square.and.pencil")
                        ...
                        .foregroundColor(ReviewTheme.brandGreen)
                        .padding(6)
                        .background(
                            RoundedRectangle(cornerRadius: 8, style: .continuous)
                                .stroke(ReviewTheme.brandGreen.opacity(0.55), lineWidth: 1)
                        )
                }
                .buttonStyle(.plain)
            }
        ...
        .background(
            RoundedRectangle(cornerRadius: 18, style: .continuous)
                .fill(ReviewTheme.cardFill)
                .overlay(
                    RoundedRectangle(cornerRadius: 18, style: .continuous)
                        .stroke(ReviewTheme.cardBorder, lineWidth: 1)
                )
        )
    }
}
